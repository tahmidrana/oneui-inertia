    ...
    <aside id="side-overlay">
        ...
        <div class="content-header border-bottom">
            ...
            <a class="img-link mr-1" href="javascript:void(0)">
                <img class="img-avatar img-avatar32" src="{{ asset('theme/media/avatars/avatar10.jpg') }}" alt="">
            </a>
            <!-- END User Avatar -->
                        ...
                        <div class="block">
                            ...
                            <div class="block-content">
                                ...
                                <ul class="nav-items mb-0">
                                    ...
                                    <li>
                                        <a class="text-dark media py-2" href="{{ route('set-user-type', ['user_type' => $userRole->id]) }}">
                                            <div class="mr-3 ml-2">
                                    ...
                                    <li>
                                        <a class="media py-2" href="javascript:void(0)">
                                            <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                <img class="img-avatar img-avatar48" src="{{ asset('theme/media/avatars/avatar6.jpg') }}" alt="">
